              ...
              child: Column(
                ...
                children: [
                  ...
                  heatmap.when(
                    ...
                    error: (e, _) =>
                        Text('Error heatmap: $e',
                            style: const TextStyle(color: Colors.red)),
                  ),
                  const SizedBox(height: 8),
                  Text('Más oscuro = más progreso (hábitos, foco y XP)',
                      style: Theme.of(context)
                          .textTheme
                          .bodySmall
          ...
          Card(
            child: Padding(
              ...
              child: weekly.when(
                ...
                error: (e, _) => Text('Error weekly focus: $e',
                    style: const TextStyle(color: Colors.red)),
              ),
            ),
          ),
          ...
          Card(
            child: Padding(
              ...
              child: topHabits.when(
                ...
                error: (e, _) => Text('Error top habits: $e',
                    style: const TextStyle(color: Colors.red)),
              ),
            ),
          ),
